/*-----------------------------------------------------------------------------------
    ...
    Theme Name: Bitsy - Proof
    Theme URI: http://
    Description: Childproofing service
    Author: Ivan Hill
    Author URI: Bitsy-Proof.png
    Version: 1.0
...
$(function () {
  ...
  wind.on("scroll", function () {
    ...
    if (bodyScroll > 300) {
      ...
      logo.attr("src", "assets/imgs/Bitsy-Proof.png");
    } else {
  ...
  $(".topnav .menu-icon").on("click", function () {
    ...
    if (open) {
      ...
      logoChan.attr("src", "img/Bitsy-Proof.png");
